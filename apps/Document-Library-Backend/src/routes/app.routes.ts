...
import { chatRoutes, searchRoutes } from './search.routes';
...
router.use('/api/chat', authenticateToken, chatRoutes);


router.get('/api/dashboard', authenticateToken, (req, res, next) => {
